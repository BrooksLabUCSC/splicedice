...
class CommandLine(object):
    ...
    and help, attributes: myCommandLine.args is a dictionary which includes
    each of the available command line arguments as
    ...
    def __init__(self, inOpts=None):
        ...
        self.parser = argparse.ArgumentParser(
            description="constructMESA.py - Construct splicing table",
        ...
        self.parser.add_argument(
            ...
            required=False,
            default="gtag_only",
            type=lambda x: self.is_valid_filter(self.parser, x),
